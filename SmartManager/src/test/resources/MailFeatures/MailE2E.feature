Feature: End to End Tests for Mail
  ...
  Scenario: Setup S-Mail campaign with productset rule
    ...
    And I Create Product Set "TestproductSetE2E" and products number "1" with Suffix "WL201062112"
    Given I goto ProductSet "TestproductSetE2E"
    And I click Edit On Product Set "TestproductSetE2E"
    And I Add "1" Products with Suffix "WL154193017"
    Given I goto Mail Campaign "E2EAutoCreate"
    And I click on link "2. Configuration"
