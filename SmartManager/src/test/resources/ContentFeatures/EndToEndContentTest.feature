Feature: End to End Tests For Smart Content
  ...
  Scenario Outline: Add new creatives with all field values parameterized
    ...
    Examples: Field values
      ...
      | E2EAuto Desktop Orlando Tours Category    | https://www.floridatix.com/images/static/home-carousel/tours.jpg  | https://www.floridatix.com/orlando-tours 			  |	Orlando Tours         | location:orlando | location:orlando, |
